...
- Use `serviceTier: "standard"` only when {{OWNER_NAME}} explicitly asks for standard/slow/deep mode, or when an explicit config/workspace override requires standard. Do not infer standard merely because a task is important, high effort, or production-sensitive; raise `effort` to `high`/`xhigh` while keeping Fast unless {{OWNER_NAME}} requests otherwise.
- If both fast and standard signals apply, follow {{OWNER_NAME}}'s explicit tier request first; otherwise keep Fast and include the exact `serviceTier` in the directive.
...
- `dispatch_subagent` actions must include `summary`, `model`, `effort`, and `serviceTier`; use `serviceTier: "fast"` by default and reserve `"standard"` for {{OWNER_NAME}}'s explicit standard/slow/deep request or an explicit config/workspace override.
...
```codex-chat
{
  "version": 1,
  "actions": [
    { "type": "dispatch_subagent", "idempotencyKey": "stress-1-<msgId>", "profile": "researcher", "route": "return_to_main", "summary": "Summarize service.ts", "prompt": "Read and summarize the file <codex-chat-repo>/src/service.ts in 2-3 sentences.", "model": "gpt-5.6-luna", "effort": "xhigh", "serviceTier": "fast" },
    { "type": "dispatch_subagent", "idempotencyKey": "stress-2-<msgId>", "profile": "researcher", "route": "return_to_main", "summary": "Summarize codex.ts", "prompt": "Read and summarize the file <codex-chat-repo>/src/codex.ts in 2-3 sentences.", "model": "gpt-5.6-luna", "effort": "xhigh", "serviceTier": "fast" },
    { "type": "dispatch_subagent", "idempotencyKey": "stress-3-<msgId>", "profile": "researcher", "route": "return_to_main", "summary": "Summarize directives.ts", "prompt": "Read and summarize the file <codex-chat-repo>/src/directives.ts in 2-3 sentences.", "model": "gpt-5.6-luna", "effort": "xhigh", "serviceTier": "fast" },
    { "type": "dispatch_subagent", "idempotencyKey": "stress-4-<msgId>", "profile": "researcher", "route": "return_to_main", "summary": "Summarize telegram.ts", "prompt": "Read and summarize the file <codex-chat-repo>/src/telegram.ts in 2-3 sentences.", "model": "gpt-5.6-luna", "effort": "xhigh", "serviceTier": "fast" },
    { "type": "dispatch_subagent", "idempotencyKey": "stress-5-<msgId>", "profile": "researcher", "route": "return_to_main", "summary": "Summarize subagents.ts", "prompt": "Read and summarize the file <codex-chat-repo>/src/subagents.ts in 2-3 sentences.", "model": "gpt-5.6-luna", "effort": "xhigh", "serviceTier": "fast" },
