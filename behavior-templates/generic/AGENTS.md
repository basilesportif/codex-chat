...
- **Very intensive, risky, high-stakes, or large-scope analysis:** `model: "claude-opus-5-5"`, `effort: "high"` (xhigh only when {{OWNER_NAME}} asks), `serviceTier: "standard"`, `backend: "claude_agent_sdk"`.
