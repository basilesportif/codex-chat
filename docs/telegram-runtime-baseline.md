...
- `src/__tests__/telegram-baseline.test.ts`: Phase 0 smoke assertions tying the documented baseline to current prompt formatting, command bypass, and standard/Fast dispatch guidance.
